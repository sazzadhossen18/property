...
<div class="featured_slick_gallery gray d-block d-md-block d-lg-block d-xl-none">
				<div class="featured_slick_gallery-slide slick-initialized slick-slider"><button type="button" data-role="none" class="slick-prev slick-arrow" aria-label="Previous" role="button" style="">Previous</button>
					<div aria-live="polite" class="slick-list draggable" style="padding: 0px 80px;"><div class="slick-track" role="listbox" style="opacity: 1; width: 0px; transform: translate3d(320px, 0px, 0px);"><div class="featured_slick_padd slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1" style="width: 0px;"><a href="assets/img/slider-4.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-4.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 0px;"><a href="assets/img/slider-5.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-5.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide slick-current slick-active slick-center" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 0px;"><a href="assets/img/slider-2.jpg" class="mfp-gallery" tabindex="0"><img src="assets/img/slider-2.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide01" style="width: 0px;"><a href="assets/img/slider-3.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-3.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide02" style="width: 0px;"><a href="assets/img/slider-4.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-4.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide03" style="width: 0px;"><a href="assets/img/slider-5.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-5.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide slick-cloned slick-center" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 0px;"><a href="assets/img/slider-2.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-2.jpg" class="img-fluid mx-auto" alt=""></a></div><div class="featured_slick_padd slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 0px;"><a href="assets/img/slider-3.jpg" class="mfp-gallery" tabindex="-1"><img src="assets/img/slider-3.jpg" class="img-fluid mx-auto" alt=""></a></div></div></div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-6">
								<div class="form-group">
									...
									<div class="cld-box">
										<i class="ti-calendar"></i>
										<input type="text" name="checkout" class="form-control" value="10/24/2020" placeholder="Check Out">
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-6">
				...
				<div class="sider_blocks_wrap">
					<div class="side-booking-body">
						...
						<span id="number" data-last="+1234567896">
							<span><a href="tel:+1234567896">+1234567896</a></span>
						</span>
					</div>
				</div>
